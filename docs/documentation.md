...
| ---------|:----------------:| ---------------:| ---------------:| --------------:| --------------:|
| 1. Unique ID     | Number   | Input      | Given   | 
| 2. KfW project No. (INPRO)     | Number                  | Input  |yes|
| 3. Project-specific location identifier   | Text    | Selection |no|
| 4. Location Name    |Text  |   Input    |Yes|
| 5. Author of the Data (=the legal owner)   |Text |    Input|Yes|
| 6. Publishing restrictions due to security reasons   | Select Text (yes/no)         | Input       |    Yes           |
| 7. Date of data collection or latest update   | Date    | Input |No|
| 8. Location Activity Status  | Select Text  | Input  |Yes|
| 9. Planned or actual start date of activity at the location   | Date   |    Input   | Yes |
| 10. Activity–Description (general)  | Text |    Input | Yes |
| 11. Additional Activity–Description  | Text |   Input | No |
| 12. Location Type Code IATI | Select Text   | Selection  | Yes |
| 13. Alternative Location Type   | Text  | Input  | No |
| 14. Budget share | Currency number in EUR  | Input  | No |
| 15. DAC 5 Purpose Classification   |Text       |    Input    | Yes |
| 16. Geographic Exactness according to IATI  |Select Text (exact or approximate) |   Input | Yes |
